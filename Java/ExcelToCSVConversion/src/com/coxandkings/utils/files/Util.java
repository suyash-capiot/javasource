...
public class Util{
    ...
    {
            String inputFile = "D://ToCSVConvert//Temp//CCBS_hotel_France_20160809113656.xls";
            File inputFilePath = new File(inputFile);
//String inputFile = args[0];
            //File outputFile = new File("D://ToCSVConvert//Temp//csv//output.csv");
            String outputFilePath = "D://ToCSVConvert//Temp//1CCBS_hotel_France_20160809113656.xls";
            File outputFile = new File(outputFilePath);
//String outputFilePath = args[1];
            byte[] filecont = readBytesFromFile(inputFilePath);
            writeBytesToFile(outputFile,filecont);
