...
public class DeployConfigJAR {
	
	private static int BUFFER_SIZE = 4096;
	
	public static void deployConfigJAR(String wlConnParamsFile, String configJAR) throws Exception {
		
		WLConnectionParams connParms = new WLConnectionParams(wlConnParamsFile);
		
		String session = "deployProj" + System.currentTimeMillis();

		// get the jmx connector
		JMXConnector conn = initConnection(connParms.getAdminHost(), connParms.getAdminPort(), connParms.getUserName(), connParms.getPassword());
